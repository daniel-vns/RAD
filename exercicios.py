...
RESPOSTA LETRA D) É o framework padrão do Python para desenvolvimento de aplicações GUI.

Questão 2) Um dos frameworks do Python mais conhecidos para desenvolvimento GUI é o Flexx. Em
...
RESPOSTA LETRA C) Uma das formas de instalá-lo é através do pip, ou seja, pip install flexx.

AULA 10

Questão 1) O Tkinter é a biblioteca padrão do Python para desenvolver aplicações gráficas. Ela
...
RESPOSTA LETRA A) É uma extensão do framework Tkinter.
...
RESPOSTA LLETRA B) Substituir lacuna1 por tkinter e lacuna2 por mainloop.

AULA 11

Questão 1) PostgreSQL é um dos banco de dados mais utilizados no mundo, por ser opensource
...
RESPOSTA LETRA E) import psycopg2 con = psycopg2.connect(host='localhost', database='exemplo', user='postgres',
password='postgres123')

Questão 2) O Python possui diversos frameworks para trabalhar com banco de dados. Um desses
...
RESPOSTA LETRA B) O programa realiza uma consulta na tabela AGENDA onde o atributo id
da tabela seja igual a 1. 